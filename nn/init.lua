...
torch.include('nn','SpatialReplicationPadding.lua')
torch.include('nn','SpatialReflectionPadding.lua')
torch.include('nn','LateralConvolution.lua')
torch.include('nn','HorizontalConvolution.lua')
torch.include('nn','VerticalConvolution.lua')

torch.include('nn','BatchNormalization.lua')
torch.include('nn','SpatialBatchNormalization.lua')
torch.include('nn','SpatialCircularPadding.lua')
torch.include('nn','InstanceNormalization.lua')
torch.include('nn','TVLoss.lua')
torch.include('nn','NoiseFill.lua')
torch.include('nn','ShaveImage.lua')
torch.include('nn','ScalePixels.lua')
