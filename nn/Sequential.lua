...
function Sequential:updateOutput(input)
   ...
   for k, v in pairs (self.modules) do
      self:freeTensors(self.modules[k], true)
      self.modules[k] = nil
   end
...
local function applyToModules(self, func)
    for _, module in ipairs(self.modules) do
      func(module)
      if module.modules ~= nil then
         applyToModules(module, func)
      end
    end
end

function Sequential:training()
    applyToModules(self, function(module) module:training() end)
    parent.training(self)
end

function Sequential:evaluate()
    applyToModules(self, function(module) module:evaluate() end)
