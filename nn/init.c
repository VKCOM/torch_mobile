...
int luaopen_libnn(lua_State *L)
{
  ...
  nn_FloatSpatialReflectionPadding_init(L);
  nn_FloatBatchNormalization_init(L);
  nn_FloatLateralConvolution_init(L);
  nn_FloatVerticalConvolution_init(L);
  nn_FloatHorizontalConvolution_init(L);
  ...
  nn_DoubleSpatialReflectionPadding_init(L);
  nn_DoubleBatchNormalization_init(L); 
  nn_DoubleLateralConvolution_init(L);
  nn_DoubleVerticalConvolution_init(L);
  nn_DoubleHorizontalConvolution_init(L);
